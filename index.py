...
#ruta de vista lugares turísticos
@app.route('/lugares_turisticos', methods=['GET'])
def lugares():
    return render_template('info_cultura.html')

#mapa de Monumento la Mexicanidad
@app.route('/monumento')
def monumento():
    return render_template('monumento.html')
...
@app.route('/chamizal')
def chamizal():
    return render_template('chamizal.html')

#mapa de Parque Central
@app.route('/central')
def central():
...
@app.route('/rodadora')
def rodadora():
    return render_template('rodadora.html')

#mapa de Dunas de Samalayuca
@app.route('/dunas')
def dunas():
    return render_template('dunas.html')

#mapa de Casa de Adobe
@app.route('/adobe')
def adobe():
    return render_template('adobe.html')

#mapa de Museo de Arte
@app.route('/arte')
def arte():
    return render_template('arte.html')

#mapa de Museo de Arqueologia e Historia el Chamizal
@app.route('/historia_chami')
def historia_chami():
    return render_template('historia_chami.html')

#mapa de Museo de la Revolución de la Frontera
@app.route('/revolucion')
def revolucion():
    return render_template('revolucion.html')
